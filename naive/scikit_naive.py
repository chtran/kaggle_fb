...
if __name__ == "__main__":
    ...
    if command == "train":
        ...
        with open('scikit_nb.dat', 'rb') as input:
            nb = pickle.load(input)
        nb.test(test_file)
        ...
        with open('scikit_nb.dat', 'rb') as input:
            nb = pickle.load(input)
        nb.get_tags(test_file, output_file)
    else:
        print "scikit_nb [train] [input_file] [tags_file] ([tag_start] [tag_end])"
        print "scikit_nb [test] [test_file]"
        print "scikit_nb [get_tags] [test_file] [output_file]"
